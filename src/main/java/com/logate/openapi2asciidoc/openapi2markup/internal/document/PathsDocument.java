...
import com.logate.openapi2asciidoc.openapi2markup.internal.component.ParametersComponent;
import com.logate.openapi2asciidoc.openapi2markup.internal.component.ResponseComponent;
...
public class PathsDocument extends MarkupComponent<Document, PathsDocument.Parameters, Document> {
    ...
    private void appendServersSection(StructuralNode node, List<Server> servers) {
        ...
        servers.forEach(server -> {
            ...
            serverSection.setTitle(OpenApiHelpers.italicUnconstrained(labels.getLabel(LABEL_SERVER)) + ": " + server.getUrl());
