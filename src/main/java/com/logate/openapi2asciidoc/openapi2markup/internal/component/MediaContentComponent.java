...
import static com.logate.openapi2asciidoc.openapi2markup.config.OpenAPILabels.LABEL_CONTENT;
...
public class MediaContentComponent extends MarkupComponent<StructuralNode, MediaContentComponent.Parameters, StructuralNode> {
    ...
    public static Parameters parameters(Content content) {
        return new Parameters(content);
    }
